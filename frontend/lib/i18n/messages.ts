...
export const messages = {
  "zh-CN": {
    ...
    study: {
      ...
      general: "未设置主题",
      currentMaterialLabel: "详情",
      currentMaterialTitle: "资料详情",
      ...
      saveAnswerDraft: "保存",
      savingAnswerDraft: "保存中...",
      answerDraftSaved: "回答已保存为待审批草稿。",
      answerDraftSavedShort: "已保存",
      scopeLabel: "Study QA Scope",
      scopeTitle: "当前实现边界",
      supported: "已支持",
      supportedDescription: "仅基于当前选中资料的 chunk 做最小问答，并把问答记录写入 thread/message。",
      unsupported: "暂未支持",
      unsupportedDescription: "当前还没有 SSE、跨资料检索和正式 citations 表写入。",
      you: "你",
      agent: "Agent",
      itemCount: "条",
      chunk: "Chunk"
  ...
  en: {
    ...
    study: {
      ...
      currentMaterialLabel: "Details",
      currentMaterialTitle: "Material details",
      ...
      saveAnswerDraft: "Save",
      savingAnswerDraft: "Saving...",
      answerDraftSaved: "The answer has been saved as a pending draft.",
      answerDraftSavedShort: "Saved",
      scopeLabel: "Study QA Scope",
      ...
      unsupportedDescription: "No SSE, no cross-material retrieval, and no formal citations table yet.",
      you: "You",
      agent: "Agent",
      itemCount: "items",
      chunk: "Chunk"
